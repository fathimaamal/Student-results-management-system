...
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode,SubjectCredit) VALUES(:subjectname,:subjectcode,:subjectcredit)";
...
<div class="form-group">
 ...
 <input type="text" name="subjectcredit" class="form-control" id="default" placeholder="Subject Credit" required="required">
                                                    </div>
