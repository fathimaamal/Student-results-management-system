...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectCode=:subjectcode,SubjectCredit=:subjectcredit where id=:sid";
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" value="<?php echo htmlentities($result->SubjectCode);?>"  id="default" placeholder="Subject Code" required="required">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="subjectcredit" class="form-control" value="<?php echo htmlentities($result->SubjectCredit);?>"  id="default" placeholder="Subject Credit" required="required">
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
