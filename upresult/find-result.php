...
<html lang="en">
    ...
    <body class="" style="background-image: url(assets/images/gra.png);
            ...
            <div class="login-bg-color">
                <div class="row">
                    <div class="col-md-4 col-md-offset-7">
                        <div class="panel login-box" style="    background:#510400;">
                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post" class="admin-login">
                                	<div class="form-group">
                                		<label for="rollid" class="control-label">Enter your Index Number</label>
